...
\renewcommand{\maketitle}{
	...
	\PlaceText{5.8cm}{13cm}{\LARGE \bfseries \color{gfzblue} \@title \\[\baselineskip]
	 ...
	 %title footer:
	\PlaceText{5.8cm}{22cm}{\Large \rstStrText \rstStrNum \\
	  					   \normalsize \rstStrSeriesText \par}
	...
	{\footnotesize
		...
		\rstReportCitationPreamble 				\newline\newline
		\rstDoiCitation 						\newline\newline\newline
		\ifnotempty{\rstDoiDatasetCitation}{%
			\rstDatasetCitationPreamble 			\newline\newline
			\rstDoiDatasetCitation 					\newline\newline\newline%
		}
		\ifnotempty{\rstDoiSupplementaryDataCitation}{%
			\rstSupplementaryDataCitationPreamble 	\newline\newline
			\rstDoiSupplementaryDataCitation		\newline\newline\newline%
		}
	...
	\PlaceText{4cm}{10cm}{\LARGE \bfseries \@title \\[\baselineskip]
	 ...
	 %title footer:
	\PlaceText{4cm}{23.5cm}{\Large \rstStrText \rstStrNum \\
	  					   \normalsize \rstStrSeriesText \par}
